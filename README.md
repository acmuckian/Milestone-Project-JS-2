...
| Too many villagers were being shown when the page loaded on the front page instead of just 10. | this was because displayAllVillagers() was called instead of showAllVillagers(), so this was amended so that showAllVillagers() was called. |
